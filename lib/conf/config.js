...
class Config {
   ...
   */
  _loadConfigFromFile () {
    this._setWithDefault('serviceAuthType', C.CF_SERVICE_AUTH_TYPE, '[none|basic|oauth2]')
    this._setWithDefault('serviceAuthTokenUri', C.CF_SERVICE_AUTH_TOKEN_URI, 'https:[yourAuthserver]/oauth/token')
    this._setWithDefault('serviceAuthGrantType', C.CF_SERVICE_AUTH_GRANT_TYPE, 'client_credentials')
    this._setWithDefault('serviceAuthClientId', C.CF_SERVICE_AUTH_CLIENT_ID, '[serviceKeyClientId]')
    this._setWithDefault('serviceAuthClientSecret', C.CF_SERVICE_AUTH_CLIENT_SECRET, '[serviceKeyClientSecret]')
    this._setWithDefault('serviceAuthUsername', C.CF_SERVICE_AUTH_USERNAME, '[YourUsername]')
    this._setWithDefault('serviceAuthPassword', C.CF_SERVICE_AUTH_PASSWORD, '[YourPassword]')
    this._setWithDefault('serviceUri', C.CF_SERVICE_URI, 'https:[yourserver]/[yourservice]')
    ...
    this._setWithDefault('testParallelChannelcount', C.CF_TEST_PARALLEL_CHANNELCOUNT, 10)
