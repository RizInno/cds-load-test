...
class Config {
  ...
  getConfiguration () {
    return {
      ...
      Test: {
        ...
        customRest: {
          massChangeServiceAndAction: this.testCustomRestMasschangeServiceAndAction
        }
      },
      Report: {
  ...
  setConfiguration (config) {
    ...
    this._setConfigurationValueWithDefault(config, 'testCustomRestMasschangeServiceAndAction', C.CF_TEST_CUSTOM_SERVICE_AND_ACTION, C.DEFAULT_TEST_CUSTOM_SERVICE_AND_ACTION)
  ...
  _loadConfigFromFile () {
    ...
    this._setConfigFileValueWithDefault('testCustomRestMasschangeServiceAndAction', C.CF_TEST_CUSTOM_SERVICE_AND_ACTION, C.DEFAULT_TEST_CUSTOM_SERVICE_AND_ACTION)
  ...
  // Custom
  testCustomRestMasschangeServiceAndAction // Combined Service path and Action name to be called in Custom Rest MassChange endpoint
