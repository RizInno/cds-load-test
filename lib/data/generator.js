...
export default class Generator {
   ...
   */
  getTimeStamp () {
    // To determine the date I add a random float to a random integer and use them as input for Date
    const ts = this._getRandomInt(-500000000, 5000000000000) + Math.fround(this._getRandomInt(-5000000, 5000000) / this._getRandomInt(-5000000, 5000000))

    // Use number value as input for date
    const curDate = new Date(ts)

    // Return Timstamp in ISO format
